...
* На мини-карте присутствуют разрывы. Работе радара не мешают, просто иногда появляются черные полоски. Клиент
не умеет нормально склеивать мини-карту на нестандартных размерах.
